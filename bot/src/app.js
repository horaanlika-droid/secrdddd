...
/* ---------- polling ----------
   Ошибка polling (нет сети, неверный токен, лимит Telegram) не должна
   ронять контейнер: HTTP API для веб-версии важнее, а polling
   попробуем снова через 15 секунд. */
